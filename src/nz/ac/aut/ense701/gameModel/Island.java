...
public class Island
{
    ...
    *************************************************************************************************************************/
    ...
    public void updateAllKiwiPosition(){
            ...
            for(int j=0; j<islandGrid.length; j++){
                ...
                for(int k = 0; k < occupants.length; k++){
                    if(occupants[k] instanceof Kiwi){
                        ...
                        g.removeOccupant(occupants[k]);
                    }
                    if(occupants[k] instanceof trail){
                        g.removeOccupant(occupants[k]);
                    }
                }
            }
        ...
        for(Kiwi kiwi : kiwis){
           // Position hold = kiwi.getPosition();
           // this.addOccupant(hold,new trail(hold,"trail","TR") );
    ...
    private void updateKiwiPosition(Kiwi kiwi)
    {
        ...
        ///
        this.addOccupant(previousKiwiPos,new trail(previousKiwiPos,"trail","TR") );
    ...
    public void updateAllPredatorPosition(){
        ...
        for(Predator predator : predators){
            ...
            Position holdPred = predator.getPosition();
            if(this.getOccupantName(holdPred).equalsIgnoreCase("trap")){
                this.removeOccupant(holdPred, predator);
                updatePredatorTrap();
            }
        }
    ...
    private int predatorsTrap= 0;
    
    public void updatePredatorTrap(){
        predatorsTrap++;
    }
    public int getPredatorTrap(){
        return predatorsTrap;
    }
